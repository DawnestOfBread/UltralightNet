...
public static unsafe class UlPlatform
{
	...
	{
		set => Methods.ulPlatformSetSurfaceDefinition((surfaceDefinitionWrapper = new ISurfaceDefinition.Wrapper(value))
			.NativeStruct);
	}
	...
	{
		void ILogger.LogMessage(LogLevel logLevel, string message)
		{
	...
	private sealed class DefaultResourceOnlyFileSystem : IFileSystem
	{
		...
		string IFileSystem.GetFileCharset(string path)
		{
			return "utf-8";
		}
